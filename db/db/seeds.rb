...
user1 = User.create(id: 1, username: "Melissa3")
user2 = User.create(id: 2, username: "Nick5")

#create some blob posts

blog1 = BlogPost.create(id: 1, content: "Weekend in the city", user_id: 1)
blog2 = BlogPost.create(id: 2, content: "How I fixed my truck", user_id: 2)
